...
$(".car").delay(500).animate({left: -220}, 1000, function() {
$(".car").delay(500).animate({left: -225}, 1000, function() {
...
$("li:nth-child(4)").delay(500).show("drop", {direction: "down",easing: 'easeInOutCirc'}, 1000, function() {
$(".chat-w").animate({scrollTop: current_height}, 1000, function() {
$("li:nth-child(5)").delay(500).show("drop", {direction: "down",easing: 'easeInOutCirc'}, 1000, function() {
